...
import { changeItemsAppearance, transformItems } from '@app/wireframes/redux/reducers/appearance.ts';
import { changeColor, changeSize, renameDiagram } from '@app/wireframes/redux/reducers/diagrams.ts';
import { renameItems, selectItems } from '@app/wireframes/redux/reducers/items.ts';
