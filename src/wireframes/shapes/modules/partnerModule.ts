...
const DEFAULT_APPEARANCE = {
  ...
  [DefaultAppearance.TEXT]: "Partner Module",
  [DefaultAppearance.TITLE]: "Partner Module",
  [DefaultAppearance.DESC]: "Provides information of Partner, contains following information: title, email, content, commondity.",
  [DefaultAppearance.TECH]: "Express",
  [DefaultAppearance.ACTION]: "service",
  [SHAPE]: SHAPE_RECTANGLE,
};

export class PartnerModule implements ShapePlugin {
  public identifier(): string {
    return "Partner Module";
  }
