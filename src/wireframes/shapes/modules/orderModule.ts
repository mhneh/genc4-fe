...
const DEFAULT_APPEARANCE = {
  ...
  [DefaultAppearance.TEXT]: "Order Module",
  [DefaultAppearance.TITLE]: "Order Module",
  [DefaultAppearance.DESC]: "Provides information of Order, contains following information: items, user, address.",
  [DefaultAppearance.TECH]: "Express",
  [DefaultAppearance.ACTION]: "service",
  [SHAPE]: SHAPE_RECTANGLE,
};

export class OrderModule implements ShapePlugin {
