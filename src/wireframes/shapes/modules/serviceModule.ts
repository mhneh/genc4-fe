...
const DEFAULT_APPEARANCE = {
  ...
  [DefaultAppearance.TEXT]: "Service Module",
  [DefaultAppearance.TITLE]: "Service Module",
  [DefaultAppearance.DESC]: "Provides information of Service, contains following information: title, email, description, plan.",
  [DefaultAppearance.TECH]: "Express",
  [DefaultAppearance.ACTION]: "service",
  [SHAPE]: SHAPE_RECTANGLE,
};

export class ServiceModule implements ShapePlugin {
