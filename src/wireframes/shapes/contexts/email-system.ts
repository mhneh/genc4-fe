...
const DEFAULT_APPEARANCE = {
  [DefaultAppearance.BACKGROUND_COLOR]: 0x999999,
  [DefaultAppearance.FONT_SIZE]: CommonTheme.CONTROL_FONT_SIZE,
  [DefaultAppearance.FOREGROUND_COLOR]: 0xffffff,
  [DefaultAppearance.STROKE_COLOR]: CommonTheme.CONTROL_BORDER_COLOR,
  [DefaultAppearance.STROKE_THICKNESS]: CommonTheme.CONTROL_BORDER_THICKNESS,
  [DefaultAppearance.TEXT_ALIGNMENT]: "center",
  [DefaultAppearance.TEXT]: "EmailSystem",
  [DefaultAppearance.TITLE]: "E-mail System",
  [DefaultAppearance.DESC]: "The internal Microsoft Exchange e-mail system.",
  [DefaultAppearance.TECH]: "External System",
  [SHAPE]: "RECTANGLE",
};

export class EmailSystem implements ShapePlugin {
