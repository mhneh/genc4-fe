...
const DEFAULT_APPEARANCE = {
    ...
    [DefaultAppearance.TEXT]: 'SignInController',
    [DefaultAppearance.TITLE]: 'Sign In Controller',
    [DefaultAppearance.DESC]: 'Allows users to sign in to the Blog System.',
    [DefaultAppearance.TECH]: 'Spring MVC Rest Controller',
    [SHAPE]: SHAPE_RECTANGLE,
};

export class SignIn implements ShapePlugin {
