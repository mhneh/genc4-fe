...
const DEFAULT_APPEARANCE = {
    ...
    [DefaultAppearance.TEXT]: 'SinglePageApplication',
    [DefaultAppearance.TITLE]: 'Single-Page Application',
    [DefaultAppearance.DESC]: 'Provides all the UIs and functionality of Blog System to user.',
    [DefaultAppearance.TECH]: 'JavaScript and Angular',
    [SHAPE]: 'BROWSER',
};

export class SinglePageApplication implements ShapePlugin {
