...
const DEFAULT_APPEARANCE = {
    ...
    [DefaultAppearance.TEXT]: 'Database',
    [DefaultAppearance.TITLE]: 'Database',
    [DefaultAppearance.DESC]: 'Stores user registration information, hashed authentication credentials, access logs, etc.',
    [DefaultAppearance.TECH]: 'Oracle Database Schema',
    [SHAPE]: 'DATABASE',
};

export class Database implements ShapePlugin {
